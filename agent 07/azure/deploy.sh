#!/usr/bin/env bash
# =============================================================================
# deploy.sh  —  Deploy Agent 07 to Azure Container Apps
#
# Usage:
...
# ── Config ────────────────────────────────────────────────────────────────────
RESOURCE_GROUP="rg-agent07"
LOCATION="australiaeast"
ACR_NAME="agent07acr"              # Must be globally unique; lowercase alphanumeric
ACA_ENV="env-agent07"
ACA_INTERNAL_SUFFIX="internal.reddesert-36d5f493.australiaeast.azurecontainerapps.io"
STORAGE_ACCOUNT="agent07sa"        # Globally unique; 3-24 lowercase alphanumeric chars
...
echo ""
echo "╔══════════════════════════════════════════════════════════╗"
echo "║  Agent 07  —  Azure Container Apps  ✓ Deployed           ║"
echo "╠══════════════════════════════════════════════════════════╣"
