...
flowchart LR
    ...
    subgraph DE["Document Extractor"]
        ...
        DE5["_SYMBOL_REF table<br/>→ canonical label→description mapping<br/>applied after Phase 1.3 gap fill"]
    end
...
flowchart TD
    ...
    subgraph PIPELINE["Agent Pipeline  (Docker Compose)"]
        ...
        subgraph SPECIALISTS["Specialist Agents"]
            ...
            DEXT["Document Extractor :8090<br/>/extract — deep content extraction<br/>text · vision (phases 1→1.5) · spreadsheet"]
            DCHK["Document Chunker :8091<br/>/chunk — PDF → PNG tiles<br/>page-split (A3) · quadrant-split (A2/A1/A0)"]
            DANT["Data Analytics :8092<br/>/analyse — asset enrichment<br/>Python-built register · CCA analysis report"]
        end
    ...
    subgraph OUTPUT["Artefacts  /app/OUTPUT/"]
        ...
        A4B["EnrichedAssets_{ts}.json"]
        A5["ConsolidatedReport_{ts}.json"]
        A5B["AnalysisReport_{ts}.json"]
