#!/usr/bin/env bash
# =============================================================================
# deploy.sh  —  Deploy Agent 08 to Azure Container Apps
#
# Usage:
...
# ── Config ────────────────────────────────────────────────────────────────────
RESOURCE_GROUP="rg-agent08"
LOCATION="australiaeast"
ACR_NAME="agent08acr"              # Must be globally unique; lowercase alphanumeric
ACA_ENV="env-agent08"
ACA_INTERNAL_SUFFIX="internal.reddesert-36d5f493.australiaeast.azurecontainerapps.io"
STORAGE_ACCOUNT="agent08sa"        # Globally unique; 3-24 lowercase alphanumeric chars
...
echo ""
echo "╔══════════════════════════════════════════════════════════╗"
echo "║  Agent 08  —  Azure Container Apps  ✓ Deployed           ║"
echo "╠══════════════════════════════════════════════════════════╣"
